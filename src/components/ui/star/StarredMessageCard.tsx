...
import { Trash2, Copy, Eye, ChevronsRight } from 'lucide-react';
...
export const StarredMessageCard: React.FC<StarredMessageCardProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-md shadow-sm border border-gray-200 dark:border-gray-700 p-3 hover:shadow-md transition-shadow duration-200">
