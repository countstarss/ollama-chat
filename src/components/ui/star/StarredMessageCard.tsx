...
export const StarredMessageCard: React.FC<StarredMessageCardProps> = ({
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 rounded-md shadow-sm border border-gray-200 dark:border-gray-700 p-3 hover:shadow-md transition-shadow duration-200 ${
        isCollection ? "border-l-4 border-l-purple-500" : ""
      }`}
    >
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            {isCollection && <Layers className="h-4 w-4 text-purple-500" />}
            <EditableStarTitle
